var CONFIG_NAMES = {
    en: {
        ...
        "playerSafeSpawn": strData(null, "1 - do not spawn player if no safe spot found, otherwise can spawn inside other players or over ejects, otherwise can spawn inside other players or over ejects"),
        
        "mobilePhysics": strData(null, "Whether or not the server uses mobile first io game physics (faster splits)"),
        "maxPlayersCount": strData(null, "Max players count that can join"),
        "mapSize": strData(null, "Map size"),
        "killAllScoreLimit": strData(null, "Server kills all players when somebody reaches this limit, 0 - disable"),
    ...
    ru: {
        ...
        "playerSafeSpawn": strData(null, "1 - do not spawn player if no safe spot found, otherwise can spawn inside other players or over ejects"),
    ...
    es: {
        "playerStartMass": strData(null, "Masa inicial del jugador"),
        "playerMaxMass": strData(null, "Tamaño máximo de la celda del jugador"),
        "playerMaxCells": strData(null, "Máximo de celdas que puede tener el jugador"),
        "playerSpeed": strData(null, "Multiplicador de la velocidad del jugador (1=velocidad normal, 2=más rápido)"),
        "playerDecayRate": strData(null, "Tamaño que se pierde por segundo"),
        "playerDecayRate": strData(null, "Cantidad (porcentaje) de masa perdida por segundo"),
        "playerRecombineTime": strData(null, "Tiempo base para que se una"),
        "playerAutoSplit": strData(null, "1 - la celda se dividirá si alcanza el TamañoMáximo"),
        "playerAimAutoSplit": strData(null, "Control automático de la dirección de división"),
        "playerSplitDistance": strData(null, "Distancia de eyección"),
        "playerBorderReflection": strData(null, "Activar/desactivar las celdas del jugador que regresan del borde del mapa"),
        "playerSafeSpawn": strData(null, "1 - do not spawn player if no safe spot found, otherwise can spawn inside other players or over ejects"),

        "mobilePhysics": strData(null, "Si el servidor utiliza o no la física del juego IO para dispositivos móviles (divisiones más rápidas)"),
        "maxPlayersCount": strData(null, "Max players count that can join"),
        "mapSize": strData(null, "Map size"),
        "killAllScoreLimit": strData(null, "Server kills all players when somebody reaches this limit, 0 - disable"),

        "ejectSize": strData(null, "Tamaño de eyección"),
        "ejectSizeLoss": strData(null, "Tamaño de la expulsión que se tomará de la celda del jugador"),
        "ejectDistance": strData(null, "Qué tan lejos llegará su eyección después de dividirse"),
        "ejectCooldown": strData(null, "Elige el tiempo hasta que un jugador pueda volver a expulsar masa (1 tick = 40 ms)"),
        "ejectSelfEatCooldown": strData(null, "Elige el tiempo hasta que un jugador puede comer su propia masa (1 tick = 40 ms)"),
        
        "ejectBorderReflection": strData(null, "Activar/desactivar el rebote de los blobs en el borde del mapa"),
        "ejectRandomizeAngle": strData(null, "Ángulo de aleatorización de la masa expulsada"),
        "ejectCollision": strData(null, "0 - dividido pasará por dividido"),
        // "ejectMassMult": strData("Acumulación", "Cuánta más masa expulsada dará al comer"),
        "ejectSpeedSwitcher": strData(null, "Agregar botón de cambio de velocidad macro"),
        "ejectMacroSpeed": strData(null, "Cuán rápido funciona la alimentación de macros"),

        "foodMinSize": strData(null, "Tamaño mínimo de comida"),
        "foodMinAmount": strData(null, "Celdas mínimas de alimentos en el mapa"),

        "virusMinSize": strData(null, "Tamaño mínimo de los virus verdes"),
        "virusMinAmount": strData(null, "Cantidad mínima de los virus verdes en el mapa"),
        "virusDistance": strData(null, "Distancia que se juega el virus verde"),

        "speedBoosterMinAmount": strData(null, "Cantidad de la potencia de velocidad"),
        "speedBoosterTime": strData(null, "Durante cuánto tiempo estará activo"),
        "speedBoosterValue": strData(null, "Ajuste de la velocidad (1,5 = 50% rápido, 0,5 = 50% más lento"),
        "speedBoosterSize": strData(null, "Qué tamaño tendrá la potencia"),

        "mergeBoosterMinAmount": strData(null, "Cantidad de la potencia de unión"),
        "mergeBoosterTime": strData(null, "Qué tamaño tendrá"),
        "mergeBoosterValue": strData(null, "Velocidad de la unión (0,5 = 50% rápido, 1,5 = 50% más lento)"),
        "mergeBoosterSize": strData(null, "Qué tamaño tendrá"),

        "virusBoosterMinAmount": strData(null, "Cantidad mínima de los virus púrpura"),
        "virusBoosterTime": strData(null, "Durante cuánto tiempo estará activo"),
        "virusBoosterSize": strData(null, "Qué tamaño tendrá"),

        "sizeBoosterMinAmount": strData(null, "Cantidad mínima de la potencia de tamaño"),
        "sizeBoosterTime": strData(null, "Durante cuánto tiempo estará activo"),
    },
    // fr: {},
    tr: {
